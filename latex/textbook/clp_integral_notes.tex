...
now have sufficient tools to examine some simple applications of definite integrals.
...
\begin{itemize}
 \item  Concentrate on the notch. Rotate it around so that its base
...
\end{align*}
\item Notice that the numerator of this expression is exactly the derivative of its
