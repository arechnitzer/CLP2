...
areas. To simplify this further, let's only consider the case that $f$ is alway
...
\end{align*}
When the integrand contains one of these square roots, then we can us
...
\begin{eg}[$\int \frac{x^2}{\sqrt{x^2-1}} \dee{x}$]
...
% \end{center}
% \end{efig}
% In order to construct a continuous inverse function for secant, we restrict its domain
to
