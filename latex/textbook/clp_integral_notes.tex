...
% $\tfrac{\dee{u}}{dx}$ is an ordinary fraction. Then cross--multiplying
% $\tfrac{\dee{u}}{dx}=u'(x)$ gives $\dee{u}=u'(x)\dee{x}$.
%
% \medskip
...
\end{lemma}
\begin{proof}
 We simply repeatedly use long division to get
\begin{align*}
\frac{P(x)}{Q(x)^m}
...
and look at the concept of falsifiability.}. In fact, the answer is ridiculous.
