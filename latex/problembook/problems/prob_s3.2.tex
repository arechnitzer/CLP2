...
\end{center}
\begin{enumerate}[(a)]
\item Express the combined area of the black squares as a series, assuming the pattern continues forever.
\item Evaluate the series using the picture (\emph{not} the formula from your book).
\end{enumerate}
\end{Mquestion}
\begin{hint}
...
\end{hint}
\begin{answer}
$\displaystyle \frac{\sin^23}{8}+\frac{1}{8}\approx 0.1275$
\end{answer}
\begin{solution}
