...
\begin{hint}
See Example \eref{CLP101}{eg:INVTRIGa} in the
CLP--II text.
\end{hint}
...
There is a subtle but important point mentioned in the introductory text to Section~\eref{CLP101}{sec trigsub} of the CLP--II text that may help you make sense of things.
\end{enumerate}
\end{hint}
\begin{answer}
