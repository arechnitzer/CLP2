...
The Fundamental Theorem of Calculus Part 2 (Theorem \eref{CLP101}{thm:INTfundthmofcalc}
 in the CLP--II text) tells us that
\begin{align*}
...
Thereom \eref{CLP101}{thm:INTfundthmofcalc} in the CLP--II text
...
\\&=\sqrt{1-a^2}
\end{align*}
\item Let $G(x) = \frac{\pi}{4}-\frac{1}{2}\arccos(x)+\frac{1}{2}x\sqrt{1-x^2}$. We showed in part (a) that $G(x)$ is an antiderivative of $\sqrt{1-x^2}$. Since $F(x)$ is also an antiderivative of $\sqrt{1-x^2}$, $F(x) = G(x)+C$ for some constant $C$ (this is Lemma~\eref{CLP101}{lemma:+C} in the CLP--II text).
...
\end{align*}
Remark: $\int \log(ax)\ \dee{x}$ can be calculated using the method of Integration by Parts, which you will learn in Section~\eref{CLP101}{sec intbyparts} of the CLP--II text.
\end{solution}
%%%%%%%%%%%%%%%%%%
...
Remark: $\int x^3e^x\ \dee{x}$ can be calculated using the method of Integration by Parts, which you will learn in Section~\eref{CLP101}{sec intbyparts} of the CLP--II text.
...
\begin{hint}
See Example \eref{CLP101}{eg:INTftocC} in the  CLP--II text.
\end{hint}
...
Differentiate
$\displaystyle \int_x^{e^x} \sqrt{\sin t}\,\dee{t}$.
\end{question}
...
Remark: evaluating antiderivatives of this type will occupy the next section, Section~\eref{CLP101}{sec subs} of the CLP--II text.
\end{solution}
%%%%%%%%%%%%%%%%%%%
...
See Example \eref{CLP101}{eg:INTftocB} in the
%\href{http://www.math.ubc.ca/%7Efeldman/m101/clp/clp_notes_101.pdf}{CLP 101 notes}.
CLP--II text. For the absolute maximum part of the question, study the sign
of $f'(x)$.
\end{hint}
...
See Example \eref{CLP101}{eg:INTftocB} in the
%\href{http://www.math.ubc.ca/%7Efeldman/m101/clp/clp_notes_101.pdf}{CLP 101 notes}.
CLP--II text. For the ``minimum value''  part of the question, study the sign
of $f'(x)$.
\end{hint}
...
See Example \eref{CLP101}{eg:INTftocB} in the
%\href{http://www.math.ubc.ca/%7Efeldman/m101/clp/clp_notes_101.pdf}{CLP 101 notes}.
CLP--II text. For the ``maximum''  part of the question, study the sign
of $F'(x)$.
\end{hint}
...
\begin{alignat*}{3}
F(-x)&=\int_0^{-x} f(t)\ \dee{t} &&\qquad\mbox{As in Example~\eref{CLP101}{eg:lefthalfevenfunction} of the CLP--II text, since $f(t)$ is even,}\\
...
\begin{alignat*}{2}
\int_0^x g(t)\ \dee{}t &= - \int_{-x}^0 g(t)\ \dee{t}&\quad\mbox{(See Example~\eref{CLP101}{eg:areaunderoddfunction} in the CLP--II text)}\\
&=\int_0^{-x} g(t)\ \dee{t}
