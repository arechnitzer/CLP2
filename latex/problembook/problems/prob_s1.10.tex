...
of the %\href{http://www.math.ubc.ca/%7Efeldman/m101/clp/clp_notes_101.pdf}{CLP--II text}.
CLP--II text.
...
in the %\href{http://www.math.ubc.ca/%7Efeldman/m101/clp/clp_notes_101.pdf}{CLP--II text}.
...
Review   Example \eref{CLP101}{eg:PFa}
in the %\href{http://www.math.ubc.ca/%7Efeldman/m101/clp/clp_notes_101.pdf}{CLP--II text}.
CLP--II text. The  ``Algebraic Method'' and the ``Sneaky Method'' are about the same length in this problem--it's good to practice both.
\end{hint}
\begin{answer}
$-2$
\end{answer}
...
\end{Mquestion}
\begin{hint}
For each part,  use long division as in Example~\eref{CLP101}{eg:PFdd} of the CLP--II text.
\end{hint}
\begin{answer}
...
Example \eref{CLP101}{eg:PFc} in the CLP--II text.
\end{hint}
...
Using the method of Example~\eref{CLP101}{eg:PFe} in the CLP--II text,
...
Using the method of Example~\eref{CLP101}{eg:PFf} in the CLP--II text,
