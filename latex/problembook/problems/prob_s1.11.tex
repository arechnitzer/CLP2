...
volume of the hill, what will be their estimate?
\item
...
\begin{answer}
$\dfrac{472}{3}\pi\approx 494 \ {\rm ft}^3$
\end{answer}
...
You may use without proof that $\displaystyle\ddiff{4}{}{x}\left\{\frac{1}{1+x^2}\right\} = \dfrac{24(5x^4-10x^2+1)}{(x^2+1)^5}$. You may use a calculator, but only to add, subtract, multiply, and divide.
\end{question}
\begin{hint}
\begin{itemize}
...
\begin{align*}
\int_1^2 \frac{1}{1+x^2}~\dee{x}&\approx \frac{\De x}{3}\big[
