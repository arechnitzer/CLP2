...
So, the integral converges by the comparison test, Theorems~\eref{CLP101}{thm:IMPcomparison} and \eref{CLP101}{thm:IMPcomparisonFinite} in the CLP-2 text.
...
Now we have all the data we need to apply the comparison test, Theorems~\eref{CLP101}{thm:IMPcomparison} and \eref{CLP101}{thm:IMPcomparisonFinite} in the CLP-2 text.
\begin{itemize}
...
Now it's time to verify our guesses with the limiting comparison test, Theorems~\eref{CLP101}{thm:IMPcomparisonLim} and \eref{CLP101}{thm:IMPcomparisonLimFinite} in the CLP-2 text. Be careful:
...
\item Using the limiting comparison test (Theorem~\eref{CLP101}{thm:IMPcomparisonLimFinite}
