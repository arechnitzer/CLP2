...
For the limit comparison test, we calculate:
\begin{align*}
L=\lim_{n \to \infty}\frac{a_n}{b_n}&=\lim_{n \to \infty}\frac{\frac{1}{\sqrt{n}}}{\frac{1}{\sqrt[4]{n}}}=\lim_{n \to \infty}\frac{1}{\sqrt[4]{n}}=0
\end{align*}
Since the series $\sum \frac{1}{\sqrt[4]{n}}$ diverges, it is part (b) of the limit comparison test, Theorem~\eref{CLP101}{thm:SRlimitComparison} in the CLP-2 text, that is appropriate here. As the limit $L=0$, the limit comparison test doesn't apply.
\end{solution}
%%%%%%%%%%%%%%%%%%%
\begin{question}
...
=\lim_{k\rightarrow\infty} \frac{k^5-2k^4+2k}{k^5+k^2+k}
=\lim_{k\rightarrow\infty} \frac{1-2/k+2/k^4}{1+1/k^3+1/k^4} \\
&=1
\end{align*}
...
\end{align*}
Substituting $y=\sqrt{x}$, $\dee{y}=\half\frac{\dee{x}}{\sqrt{x}}$,
\begin{align*}
\int_{N}^\infty \frac{e^{-\sqrt{x}}}{\sqrt{x}}\ \dee{x}
=2\int_{\sqrt{N}}^\infty e^{-y}\ \dee{y}
