...
\end{question}
\begin{hint}
The comparison test is Theorem~\eref{CLP101}{thm:SRcomparisonTest} in the CLP--II text. However, rather than trying to memorize which way the inequalities go in all cases, you can use the same reasoning as Question~\ref{prob_s3.3:oldies}.
\end{hint}
\begin{answer}
...
\end{answer}
\begin{solution}
The comparison test is Theorem~\eref{CLP101}{thm:SRcomparisonTest} in the CLP--II text. However, rather than trying to memorize which way the inequalities go in all cases, we  use the same reasoning as Question~\ref{prob_s3.3:oldies}.
...
\end{question}
\begin{hint}
The divergence test is Theorem~\eref{CLP101}{thm:SRdivergenceTest} in the CLP--II text.
\end{hint}
\begin{answer}
...
\end{answer}
\begin{solution}
 The divergence test (Theorem~\eref{CLP101}{thm:SRdivergenceTest} in the CLP--II text) is inconclusive when $\displaystyle\lim_{n \to \infty}a_n=0$. We cannot use the divergence test to show that a series converges.
\end{solution}
...
Example \eref{CLP101}{eg:SRlimCompA} in the CLP--II text.
...
Theorem \eref{CLP101}{thm:SRintegralTest} in the CLP--II text.
\end{hint}
...
Example \eref{CLP101}{eg:IMPp1} in the CLP--II text)
with $p=\frac{3}{2} > 1$.
\end{answer}
...
\end{align*}
Using the results about $p$-series, Example~\eref{CLP101}{eg:SRpTest} in the CLP--II text,
...
CLP--II text for developing intuition about comparisons, and Example~\eref{CLP101}{eg:SRcomparisonTestB} for an example where finding an appropriate comparison series calls for some creativity.
\end{hint}
...
See Example \eref{CLP100}{eg:hopitalL} in the CLP--I text,
...
Theorem \eref{CLP101}{thm:SRlimitComparison} in the CLP--II text.
\end{itemize}
...
\end{question}
\begin{hint}
	If we add together the frequencies of all the words, they should amount to 100\%. We can approximate this sum using ideas from Example~\eref{CLP101}{eg:firstIntTest} in the CLP--II text.
\end{hint}
\begin{answer}
	About 9\% to 10\%
\end{answer}
